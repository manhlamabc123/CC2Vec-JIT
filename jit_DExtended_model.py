...
class DeepJITExtended(nn.Module):
    def __init__(self, args):
        ...
        self.fc1 = nn.Linear(Feature + 768 + len(Ks) * Co, args.hidden_units)   # hidden units
